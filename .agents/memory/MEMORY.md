...
- [Anonymous access](anonymous-access.md) — no login gates; preserve database ownership, payments, diagnostics, and visitor analytics through anonymous browser sessions.
